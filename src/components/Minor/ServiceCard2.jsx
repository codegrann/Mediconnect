...
function ServiceCard2({ title, imageSrc, description, buttonText }) {
  return (
    <div className="mb-6 max-w-80 mx-auto border-none p-0.5 bg-gradient-to-r from-[#f83904] via-black to-[#2bf607] rounded-3xl hover:animate-moveColors items-center">
